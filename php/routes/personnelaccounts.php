  ...
  <div class="modal-content form-modal">
    ...
    <form autocomplete="off" id="addUserForm" novalidate>
      ...
      <div class="modal-actions">
        ...
        <button class="cancel" type="button" id="cancelAddBtn"></button>Cancel</button>
      </div>
    </form>
  </div>
</div>
...
<!-- Scripts -->
<scrips src="../../scripts/sidebar.js"></scripts>
<scripts src="../../scripts/personnelaccount.js"></scripts>
